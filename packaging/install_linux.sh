#!/usr/bin/env sh
# Install the DME Innovation Flasher on a Linux desktop (per-user, no root).
#
...
echo "Launch it from your app menu ('DME Innovation Flasher') or run: med17flasher-desktop"
