...
| **Front-ends** | A **React (Vite) web UI** (the "DME Innovation Flasher" design, wired to the real flash engine via a JSON/SSE API), a Tkinter desktop GUI, and a full-featured CLI |
...
The `webui/` folder is the **DME Innovation Flasher** design (Mercedes-AMG C63 S
