# Installing the DME Innovation Flasher on your desktop
...
2. Double‑click it and follow the wizard. It installs to your user profile (no
   ...
   **desktop shortcut**.
3. Launch **“DME Innovation Flasher”** from the Start menu.
...
entry so **“DME Innovation Flasher”** appears in your application menu.
